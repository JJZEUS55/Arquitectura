...
HD_PWD='C:/Users/Letty/Desktop/PILA/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PILA.tcl
