...
HD_PWD='C:/Users/geoge/Desktop/Arquitectura/Arquitectura/Practica6/Datos/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Datos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Datos.tcl
