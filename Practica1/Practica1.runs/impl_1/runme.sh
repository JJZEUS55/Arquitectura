...
HD_PWD='C:/Users/geoge/Desktop/Arquitectura-master/Practica1/Practica1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador4bits.tcl -notrace
