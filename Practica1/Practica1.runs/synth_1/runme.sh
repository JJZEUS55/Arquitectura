...
HD_PWD='C:/Users/geoge/Desktop/Arquitectura-master/Practica1/Practica1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador4bits.tcl
