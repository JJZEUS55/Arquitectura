...
HD_PWD='C:/Users/geoge/Desktop/Arquitectura-master/Practica3_2/Practica3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_4bits.tcl -notrace
