...
HD_PWD='C:/Users/geoge/Desktop/Arquitectura-master/Practica3_2/Practica3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_4bits.tcl
