...
set rc [catch {
  ...
  open_checkpoint union_routed.dcp
  ...
  catch { write_mem_info -force union.mmi }
  write_bitstream -force union.bit 
  catch {write_debug_probes -quiet -force union}
  catch {file copy -force union.ltx debug_nets.ltx}
