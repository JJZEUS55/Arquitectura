...
write_checkpoint -force -noxdef union.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file union_utilization_synth.rpt -pb union_utilization_synth.pb"
