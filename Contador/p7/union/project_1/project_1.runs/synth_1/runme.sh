...
HD_PWD='C:/Users/Letty/Desktop/Arquitectura/Contador/p7/union/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log union.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source union.tcl
